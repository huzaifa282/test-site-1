...
<template>
    <div class="main-content">
        ...
        <ul>
            ...
            <li><strong>Company</strong> (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to cyde central.</li>
            ...
            <li><strong>Website</strong> refers to cyde central, accessible from <a href="https://cyde.xyz/">https://cyde.xyz/</a></li>
        ...
        <ul>
            <li>By email: <a href="mailto:cyde@cyde.xyz">cyde@cyde.xyz</a></li>
        </ul>
    </div>
</template>
